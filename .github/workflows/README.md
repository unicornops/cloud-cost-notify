...
This directory contains GitHub Actions workflows for the Cloud Cost Notify project.

## Workflows

### Release on Merge to Main (`release-on-merge.yml`)

This workflow handles both **automatic** and **manual** release creation for Cloud Cost Notify.
...
#    - Creates v1.1.0 tag
#    - Builds and releases CloudCostNotify-1.1.0.dmg
```
