...
#
# Output:
#   - build/AppStore/CloudCostNotify.xcarchive - Archive for App Store
#   - build/AppStore/CloudCostNotify.pkg - Signed package ready for upload
#
...
# Configuration
SCHEME="CloudCostNotify"
PROJECT="CloudCostNotify.xcodeproj"
BUNDLE_ID="ie.unicornops.cloudcostnotify"
